...
let baseTimestamp = new Date(Date.UTC(2069, 12, 12, 12, 59, 59, 999));
    ...
    console.info('%c>> https://hkeylocalmachine.github.io/pokes/dd8a43505f36456c0f86bf7ce58a82be.html <<',`line-height:10px;padding-block:0px;padding-left:130px;background-repeat:no-repeat; text-shadow: 0 0 3px #fff, 0 0 1px #fff, 0 0 1px #00ff33, 0 0 1px #00ff33, 0 0 2px #00ff33`);
